...
# test sample
custom_instruction="Please summarize the article that is provided \n \n"
...
get_watsonxai_response("ibm/granite-13b-chat-v1", input_text, custom_instruction, 512, 0.7, 1)
